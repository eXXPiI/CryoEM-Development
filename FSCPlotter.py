...
and matplotlib.
# Inputs/Arguments: Non-optional global FSC text file directory path and
saved image format (png or pdf most likely).
# Outputs/Returns: Generates FSC curve plot and saves them to file.
"""

## Articles

def FSCPlotter(inputPath,imageFormat):
    import re
    import os
    import math
    import numpy as np
...
if __name__ == '__main__':
    ...
    # Main Script Run
    FSCPlotter(inputPath,imageFormat)

...
and matplotlib.
# Inputs/Arguments: FSC text file.
# Outputs/Returns: Generates FSC curve plots and saves them to file.
"""

## Articles

def FSCPlotter(inputPath):
    import re
    import os
    import math
    import numpy as np
    ...
    for info in allFiles:
        try:
            ...
            pass
    baseParent = os.path.basename(os.path.normpath(inputPath))
    ...
    imageFileName = f"{dataInfo[0][1]}_{baseParent}_cycle{dataInfo[0][0]}_" \
                    f"{dataInfo[0][2]}_FSC-Overall"
    imageFormat = "pdf"
...
if __name__ == '__main__':
    ...
    inputPath = "/home/jmyers/Documents/testFolder/FSC_Test/"
    
    # Define Input Variables
    #inputPath = str(sys.argv[1])
    
    # Main Script Run
    FSCPlotter(inputPath)
